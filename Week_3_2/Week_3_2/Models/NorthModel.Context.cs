...
namespace Week_3_2.Models
{
    ...
    public partial class SampleDBEntities : DbContext
    {
        ...
        [DbFunction("SampleDBEntities", "ProductsUnderThisUnitPrice")]
        public virtual IQueryable<ProductsUnderThisUnitPrice_Result> ProductsUnderThisUnitPrice(Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ProductsUnderThisUnitPrice_Result>("[SampleDBEntities].[ProductsUnderThisUnitPrice](@price)", priceParameter);
        }
